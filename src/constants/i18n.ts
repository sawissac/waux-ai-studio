...
const en = {
  ...
  "chat.suggest.1": "Summarize a block of text",
  "chat.suggest.2": "Draft an HTTP request",
  "chat.suggest.3": "Explain a regex pattern",
...
const my: Record<MessageKey, string> = {
  ...
  "chat.suggest.1": "စာသား တစ်ပိုဒ်ကို အကျဉ်းချုပ်",
  "chat.suggest.2": "HTTP request မူကြမ်း ရေး",
  "chat.suggest.3": "Regex pattern ကို ရှင်းပြ",
